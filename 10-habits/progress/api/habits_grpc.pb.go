...
func (c *habitsClient) CreateHabit(ctx context.Context, in *CreateHabitRequest, opts ...grpc.CallOption) (*Habit, error) {
	out := new(Habit)
...
func (UnimplementedHabitsServer) CreateHabit(context.Context, *CreateHabitRequest) (*Habit, error) {
