...
func build() {
	...
	slog.Info("Let's generate maze")
	maze := generateMaze(width, height)
	slog.Info("Maze is generated")

	saveToPNG(maze, "maze.png")
	slog.Info("Maze is saved")
}
...
func generateMaze(width int, height int) *image.RGBA {
	...
	const complexity = 1 // change this for easier / creatable mazes, or harder ones.
